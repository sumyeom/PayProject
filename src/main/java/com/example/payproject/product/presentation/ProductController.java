package com.example.payproject.product.presentation;

import com.example.payproject.common.ResponseEntity;
import com.example.payproject.product.application.ProductService;
...
public class ProductController {
    ...
    @Operation(summary = "상품 등록", description = "신규 상품을 등록한다.")
    @PostMapping
    ...
    @Operation(summary = "상품 수정", description = "상품 정보를 수정한다.")
    @PutMapping("{id}")
